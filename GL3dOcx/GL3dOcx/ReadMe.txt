========================================================================
		ActiveX Control DLL : GL3DOCX
========================================================================

ControlWizard has created this project for your GL3DOCX ActiveX Control
...
that make up your GL3DOCX ActiveX Control DLL.
...
GL3dOcxCtl.h
	This file contains the declaration of the CGL3dOcxCtrl C++ class.

GL3dOcxCtl.cpp
	This file contains the implementation of the CGL3dOcxCtrl C++ class.

GL3dOcxPpg.h
	This file contains the declaration of the CGL3dOcxPropPage C++ class.

GL3dOcxPpg.cpp
	This file contains the implementation of the CGL3dOcxPropPage C++ class.

GL3dOcxCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CGL3dOcxCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file GL3dOcx.rc.
